...
const triviaImages = [
  'https://raw.githubusercontent.com/AkiraDevX/uploads/main/uploads/1766617406305_472904.jpeg',
  'https://raw.githubusercontent.com/AkiraDevX/uploads/main/uploads/1766617412185_747595.jpeg'
]
...
const handler = async (m, { conn, command }) => {
  try {
    ...
    if (command === "trivia") {
      ...
      const caption = `  ♡ㅤㅤㅤㅤົㅤ\`𝖳𝗋𝗂𝗏𝗂𝖺 𝖢𝗎𝗅𝗍𝗎𝗋𝖺𝗅\`ㅤ중ໍຕㅤㅤㅤׄ🍈
             ㅤׄᰕ \`𝖯𝗋𝖾𝗀𝗎𝗇𝗍𝖺:\` ᦡ
...
▢۟۟. 🏆 *ᴘᴜɴᴛᴏs ::* ${pointsRandom}ㅤׅㅤׄᰕ
▢۟۟. 🍚 *ᴛɪᴇᴍᴘᴏ ::* 1 Minutoㅤׅㅤׄᰕ

> .ࣹㅤ🌾 ʀᴇsᴘᴏɴᴅᴇ ᴀ ᴇsᴛᴇ ᴍᴇɴsᴀᴊᴇ ᴄᴏɴ :: ᴀ, ʙ, ᴄㅤ𑇖𑇖`.trim()
