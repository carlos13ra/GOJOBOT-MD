...
await conn.sendMessage(m.chat, { image: 'https://raw.githubusercontent.com/AkiraDevX/uploads/main/uploads/1763407840189_459215.jpeg', caption: txt, ...rcanal }, { quoted: m })
await m.react('✔️')
break
}}} catch (err) {
await m.react('✖️')
