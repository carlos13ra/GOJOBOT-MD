...
if (command === 'delprimary' || command === 'resetprimary') {
...
try {
chat.primaryBot = who
chat.primaryLastSeen = Date.now() // reinicia el timeout
...
handler.help = ['setprimary', 'delprimary', 'resetprimary']
handler.tags = ['group']
handler.command = ['setprimary', 'delprimary', 'resetprimary']
handler.group = true
handler.admin = true
