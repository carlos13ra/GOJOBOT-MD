...
/*parseMention: {
    ...
    async value(m) {
        ...
        for (const message of m) {
            try {
                if (!message) continue;
                if (!message.message) continue; // ✅ protección extra
                ...
                if (!_mtype.length) continue; // ✅ evita error reading '0'
                ...
                if (!mtype || !message.message[mtype]) continue; // ✅ blindaje total
