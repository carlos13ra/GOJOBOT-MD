...
// ⬇️⬇️⬇️ FILTRO PRIMARY PARA SKY ULTRA - 25 SUBOX ⬇️⬇️⬇️
if (m.isGroup) {
    const chat = global.db.data.chats[m.chat]
    if (chat?.primaryBot && chat.primaryBot!== this.user.jid) return
}
// ⬆️⬆️⬆️ HASTA AQUÍ EL PARCHE ⬆️⬆️⬆️
...
global.dfail = (type, m, conn) => {
 const msg = {
   ...
   owner: ` ׄ 🌾 ׅ 𝙀𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 *${comando}* 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙙𝙚𝙨𝙖𝙧𝙤𝙡𝙡𝙖𝙙𝙤𝙧𝙚𝙨 𝙙𝙚𝙡 𝙗𝙤𝙩.`,
